<?php
// Test script to verify the import functionality fix with corrected approach
...
echo "Testing the import functionality fix with corrected approach...\n";
...
try {
    ...
    $rows = $worksheet->toArray(); // Use without parameters to get numeric indices
    ...
    foreach ($rows as $row) {
        ...
        // Using numeric indices (0-based) as returned by toArray()
    ...
    echo "\nTotal data rows processed: " . $rowIndex . "\n";
