...
<div class="max-w-md mx-auto">
            ...
            <form action="<?php echo url('user/login'); ?>" method="POST" class="space-y-6">
                <div>
                    ...
                    <input
                        ...
                        value="<?= htmlspecialchars($_POST['library_card_number'] ?? '') ?>">
    ...
    <div class="mt-6 text-center py-4">
        ...
        <a href="<?php echo url('user/register'); ?>" class="text-[#13f2d] hover:text-[#0d3325] text-sm font-medium flex items-center justify-center transition-colors">
...
<?php
$title = 'User Login | Portal Unggah Skripsi Mandiri';
