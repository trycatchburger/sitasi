                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo url('submission/create_journal'); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="flex flex-col sm:flex-row items-center justify-between gap-4 pt-6">
                                ...
                                <button type="submit" class="bg-[#13f2d] hover:bg-[#0e3325] text-white text-lg font-semibold py-3 px-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 inline-flex items-center gap-2">
