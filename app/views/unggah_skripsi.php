...
<div class="w-full bg-green-50 min-h-screen">
    <div class="w-full px-4">
        ...
        <div class="text-center mb-8 bg-white rounded-xl shadow-md p-8 border-b-4 border-green-600">
            <h1 class="text-3xl font-bold text-gray-800 mb-2">UNGGAH SKRIPSI MANDIRI MAHASISWA</h1>
        ...
        <div class="w-full flex flex-col md:flex-row gap-6">
                ...
                <div class="max-w-5xl mx-auto bg-white">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo url('submission/resubmit'); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="submission_type" value="bachelor">
                        <?php else: ?>
                        <form action="<?php echo url('submission/create'); ?>" method="post" enctype="multipart/form-data">
                        <?php endif; ?>
                            ...
                            <div class="mb-8">
                                <h2 class="text-xl font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-100">Informasi Skripsi</h2>
                                ...
                                <div class="row">
                                    <div class="col md:col-6">
                                        <div class="form-group">
                                            ...
                                            <?php
                                            $programStudiOptions = [
                                                "Akuntansi Syariah" => "Akuntansi Syariah (AKS)",
                                                "Hukum Ekonomi Syariah" => "Hukum Ekonomi Syariah (HES)",
                                                "Hukum Keluarga Islam" => "Hukum Keluarga Islam (HKI)",
                                                "Ilmu Alquran dan Tafsir" => "Ilmu Alquran dan Tafsir (IAT)",
                            ...
                            <div class="mb-8">
                                ...
                                <div class="space-y-6">
                                    <div class="form-group">
                                        <label for="file_cover" class="form-label">Cover Skripsi (.pdf)</label>
                                    ...
                                    <div class="form-group">
                                        <label for="file_bab1" class="form-label">Cover s/d Bab I & Daftar Pustaka (.pdf)</label>
                                    ...
                                    <div class="form-group">
                                        <label for="file_bab2" class="form-label">Bab II s/d Bab Terakhir (.pdf)</label>
                                    ...
                                    <div class="form-group">
                                        <label for="file_doc" class="form-label">Cover s/d Daftar Pustaka (.doc, .docx)</label>
                                        <input type="file" id="file_doc" name="file_doc" required class="form-control" accept=".doc,.docx">
                                        <div class="form-text">(Format Nama File: NIM_SKRIPSI. Ukuran maksimum file: 10240KB.)</div>
                            ...
                            <button type="submit" class="bg-green-900 hover:bg-green-600 text-white text-lg font-semibold py-3 px-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 inline-flex items-center gap-2 mt-4">
            ...
            <section id="info-section" class="w-full lg:w-1/3 bg-gradient-to-br from-green-50 to-green-100 rounded-xl shadow-md p-6 space-y-6 border border-green-200 opacity-0 translate-y-8 transition-all duration-700 ease-out">
                ...
                <p class="text-gray-700 text-sm">Unggah skripsi paling lambat <strong>31 Desember 2025</strong>.</p>
                </div>
                ...
                <ol class="list-decimal pl-5 text-gray-700 text-sm space-y-1">
                    <li>Isi data dan unggah berkas skripsi (PDF).</li>
                ...
                <div class="text-gray-700 text-sm space-y-4">
                    ...
                    <div class="border border-green-200 rounded-md p-3 bg-green-50/50">
                        ...
                        <p class="ml-4">Nama file: <code class="bg-gray-100 px-1 rounded text-green-800">NIM_BAB I_DAFTAR PUSTAKA</code></p>
                        <p class="ml-4 font-semibold mt-1">Isi:</p>
                        <ul class="list-disc pl-8">
                            <li>Judul</li>
                            <li>Halaman Pengesahan</li>
                            <li>Surat Pernyataan Keaslian</li>
                            <li>Abstrak</li>
                    ...
                    <div class="border border-green-200 rounded-md p-3 bg-green-50/50">
                        ...
                        <p class="ml-4 font-semibold mt-1">Isi:</p>
                        <ul class="list-disc pl-8">
                            <li>Bab II hingga Bab terakhir</li>
                        </ul>
                    </div>

                    <!-- File 3 -->
                    <div class="border border-green-200 rounded-md p-3 bg-green-50/50">
                    <p><strong>• File 3 – Format:</strong> MS Word (.doc/.docx)</p>
                    <p class="ml-4">Nama file: <code class="bg-gray-100 px-1 rounded text-green-800">NIM_SKRIPSI</code></p>
                    <p class="ml-4 font-semibold mt-1">Isi:</p>
                    <ul class="list-disc pl-8">
                        <li>Full (dari cover hingga daftar pustaka)</li>
                    </ul>
                    </div>
...
<?php
$title = 'Unggah Mandiri | Portal Unggah Skripsi Mandiri';
