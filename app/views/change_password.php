...
<head>
    ...
    <title>Change Password - Sitasi</title>
...
<body class="bg-gradient-to-b from-green-50 to-white text-gray-800 antialiased min-h-screen flex items-center justify-center">
    <div class="max-w-md w-full bg-white p-8 rounded-xl shadow-lg">
        <div class="text-center mb-6">
            ...
            <p class="text-gray-600">Ganti password akun Anda</p>
        </div>
        ...
        <form action="<?= url('user/change_password') ?>" method="POST" class="space-y-4">
        ...
        <div class="mt-4 text-center">
            <a href="<?= url('user/profile') ?>" class="text-green-700 hover:text-green-900 text-sm font-medium">Kembali ke Profil</a>
        </div>
    </div>
</body>
</html>