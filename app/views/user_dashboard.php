...
<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <?php if (empty($submissions)): ?>
        <div class="text-center py-12">
            ...
            <div class="mt-6">
                <a href="<?= url('submission/skripsi') ?>" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-70">
                    Submit New
                </a>
            </div>
        </div>
