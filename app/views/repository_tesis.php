  ...
  <div id="submissionContainer" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 transition-all duration-300">
    ...
    <?php foreach ($submissions as $submission): ?>
      <?php
        ...
        $titleLink = '<a href="' . url('submission/' . $detailRoute . '/' . $submission['id']) . '" class="text-yellow-70 hover:text-yellow-900 font-medium hover:underline">' . htmlspecialchars($submission['judul_skripsi']) . '</a>';
      ?>
